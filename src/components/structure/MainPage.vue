<template>
  <div class="main-page-content">
    ...
    <div class="main-block" v-if="chartArray.map.show">
      <div class="main-block-title btn-group btn-row">
        <div class="btn btn-text tip-error" @click="removeThis"><font-awesome-icon :icon="['fa','fa-xmark']"></font-awesome-icon></div>
      </div>
